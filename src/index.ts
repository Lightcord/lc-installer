...
switch(platform){
    case "win":
        ...
        installer.start(isMain).catch((err) => {
            console.error(err)
            console.log(`An error occured in the main process. Please refer to \x1b[33mhttps://github.com/Lightcord/LightcordInstaller\x1b[0m to how to solve it or join our Discord \x1b[33m${DiscordLink}\x1b[0m`)
        })
        break
    case "linux":
    case "android":
